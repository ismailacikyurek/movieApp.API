...
class  PersonViewModel:NSObject {
    ...
    func theMovieDbService(personId : Int?) {
        ...
        service.fethAllPosts(url: urlPerson) { [weak self] model in
        ...
        service.fethAllPosts(url: urlPersonMovies) { [weak self] model in
        ...
        service.fethAllPosts(url: urlPersonTvs) { [weak self] model in
